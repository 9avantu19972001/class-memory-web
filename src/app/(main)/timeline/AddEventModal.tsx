...
import { X, Loader2, Upload, Calendar, Sparkles, Image as ImageIcon } from 'lucide-react'
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-bold font-serif text-foreground">
                Ghi Dấu Cột Mốc Kỷ Niệm
              </h2>
              <p className="text-xs text-foreground/60">
                Thêm một sự kiện đáng nhớ vào dòng thời gian 4 năm cấp 2 Lớp 9A
              </p>
            </div>
          </div>
          <button
        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-5 overflow-y-auto flex-1 text-xs">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
            <div className="sm:col-span-2">
              ...
              <input
                type="text"
                required
                placeholder="Ví dụ: Ngày đầu nhận lớp 6A, Hội thi kéo co..."
                value={title}
          ...
          <div>
            ...
            <textarea
              required
              rows={4}
              placeholder="Chia sẻ cảm xúc, những chi tiết thú vị, những câu nói vui của thầy cô và bạn bè trong ngày hôm ấy..."
              value={description}
